...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero-centered { align-items: center; justify-content: center; min-height: 580px; }
    ...
    .hero-logo { height: 420px; width: auto; max-width: 88%; display: block; filter: drop-shadow(0 6px 32px rgba(0,0,0,.6)); flex-shrink: 0; }
